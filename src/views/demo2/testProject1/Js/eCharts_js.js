$(function () {
    //销售动态滚动
    $(".content .bottom .left .left_bottom").append($("#datas").clone());
    var n=0;
    setInterval(function () {
        n+=5;
        $(".content .bottom .left .left_bottom").scrollTop(n);
        if ($(".content .bottom .left .left_bottom").scrollTop()>=$("#datas").height()){
            n=0;
        }
    },100);

    // 销售趋势
    var mychart1 = echarts.init(document.getElementsByClassName("left_top")[0]);
    //滚动
    // mychart1.hideLoading();
    // mychart1.setOption(option);
    // setInterval(function () {
    //    if (option.dataZoom[0].endValue === charts.value.length - 1){
    ...
    var charts = {
        ...
        value: [
            [306, 352, 425, 497, 532, 408, 679, 702, 756, 798, 823, 877],
        ]
    ...
    // 店铺分布图
    var mychart2 = echarts.init(document.getElementsByClassName("center")[0]);
    var geoCoordMap = {
        '上海': [121.4648, 31.2891],
        '东莞': [113.8953, 22.901],
        '东营': [118.7073, 37.5513],
